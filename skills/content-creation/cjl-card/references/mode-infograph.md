...
Read `~/.claude/skills/cjl-card/assets/infograph_template.html`
...
```bash
node ~/.claude/skills/cjl-card/assets/capture.js /tmp/ljg_cast_infograph_{name}.html ~/Downloads/{name}.png 1080 800 fullpage
```
