...
Read `~/.claude/skills/cjl-card/assets/sketchnote_template.html`
...
```bash
node ~/.claude/skills/cjl-card/assets/capture.js /tmp/ljg_cast_sketchnote_{name}.html ~/Downloads/{name}.png 1080 800 fullpage
```
